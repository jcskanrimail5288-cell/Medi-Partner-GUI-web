...
回答を作成する際は、必ず以下の公式マニュアルサイトを**深く探索し**、最も関連性の高い情報源を見つけてから、その内容に基づいてください。
マニュアルに記載のない内容については、安易に創作せず、「公式マニュアルでは確認できませんでした」と正直に伝えてください。

- **ORCAマニュアル（外来）:** https://orcamanual.orca.med.or.jp/gairai/
- **ORCAマニュアル（入院）:** https://orcamanual.orca.med.or.jp/nyuin/
